...
func Test_authors_BlogAuthorsApiService(t *testing.T) {
	...
	t.Run("Test BlogAuthorsApiService Archive", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BlogAuthorsApi.Archive(context.Background(), objectId).Execute()
	...
	t.Run("Test BlogAuthorsApiService BatchArchive", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BlogAuthorsApi.BatchArchive(context.Background()).Execute()
	...
	t.Run("Test BlogAuthorsApiService SetLanguagePrimary", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BlogAuthorsApi.SetLanguagePrimary(context.Background()).Execute()
