...
func Test_blog_posts_BlogPostsApiService(t *testing.T) {
	...
	t.Run("Test BlogPostsApiService Archive", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BlogPostsApi.Archive(context.Background(), objectId).Execute()
	...
	t.Run("Test BlogPostsApiService BatchArchive", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BlogPostsApi.BatchArchive(context.Background()).Execute()
	...
	t.Run("Test BlogPostsApiService PushLive", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BlogPostsApi.PushLive(context.Background(), objectId).Execute()
	...
	t.Run("Test BlogPostsApiService ResetDraft", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BlogPostsApi.ResetDraft(context.Background(), objectId).Execute()
	...
	t.Run("Test BlogPostsApiService Schedule", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BlogPostsApi.Schedule(context.Background()).Execute()
	...
	t.Run("Test BlogPostsApiService SetLanguagePrimary", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BlogPostsApi.SetLanguagePrimary(context.Background()).Execute()
