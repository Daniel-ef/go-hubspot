...
------------ | ------------- | ------------- | -------------
*AssociationsApi* | [**AssociationsGetAll**](docs/AssociationsApi.md#associationsgetall) | **Get** /crm/v4/objects/companies/{companyId}/associations/{toObjectType} | List
*AssociationsApi* | [**DeleteCrmV4ObjectsCompaniesCompanyIdAssociationsToObjectTypeToObjectIdArchive**](docs/AssociationsApi.md#deletecrmv4objectscompaniescompanyidassociationstoobjecttypetoobjectidarchive) | **Delete** /crm/v4/objects/companies/{companyId}/associations/{toObjectType}/{toObjectId} | Delete
*AssociationsApi* | [**PutCrmV4ObjectsCompaniesCompanyIdAssociationsToObjectTypeToObjectIdCreate**](docs/AssociationsApi.md#putcrmv4objectscompaniescompanyidassociationstoobjecttypetoobjectidcreate) | **Put** /crm/v4/objects/companies/{companyId}/associations/{toObjectType}/{toObjectId} | Create
