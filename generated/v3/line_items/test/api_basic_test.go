...
func Test_line_items_BasicApiService(t *testing.T) {
	...
	t.Run("Test BasicApiService Archive", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BasicApi.Archive(context.Background(), lineItemId).Execute()
	...
	t.Run("Test BasicApiService GetByID", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BasicApi.GetByID(context.Background(), lineItemId).Execute()
	...
	t.Run("Test BasicApiService Update", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.BasicApi.Update(context.Background(), lineItemId).Execute()
