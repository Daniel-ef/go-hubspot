...
func (a *AssociationsApiService) AssociationsGetAllExecute(r ApiAssociationsGetAllRequest) (*CollectionResponseMultiAssociatedObjectWithLabelForwardPaging, *http.Response, error) {
	...
	localVarPath := localBasePath + "/crm/v4/objects/products/{productId}/associations/{toObjectType}"
...
type ApiDeleteCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdArchiveRequest struct {
	ctx          context.Context
	ApiService   *AssociationsApiService
	productId    int64
	toObjectType string
...
func (r ApiDeleteCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdArchiveRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdArchiveExecute(r)
}
...
deletes all associations between two records.
	...
	@param toObjectType
	@param toObjectId
	@return ApiDeleteCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdArchiveRequest
*/
...
func (a *AssociationsApiService) DeleteCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdArchiveExecute(r ApiDeleteCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdArchiveRequest) (*http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AssociationsApiService.DeleteCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdArchive")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/crm/v4/objects/products/{productId}/associations/{toObjectType}/{toObjectId}"
	localVarPath = strings.Replace(localVarPath, "{"+"productId"+"}", url.PathEscape(parameterToString(r.productId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"toObjectType"+"}", url.PathEscape(parameterToString(r.toObjectType, "")), -1)
...
type ApiPutCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdCreateRequest struct {
	ctx             context.Context
	ApiService      *AssociationsApiService
	productId       int64
	toObjectType    string
...
func (r ApiPutCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdCreateRequest) Execute() (*LabelsBetweenObjectPair, *http.Response, error) {
	return r.ApiService.PutCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdCreateExecute(r)
}
...
Set association labels between two records.
	...
	@param toObjectType
	@param toObjectId
	@return ApiPutCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdCreateRequest
*/
...
func (a *AssociationsApiService) PutCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdCreateExecute(r ApiPutCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdCreateRequest) (*LabelsBetweenObjectPair, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AssociationsApiService.PutCrmV4ObjectsProductsProductIdAssociationsToObjectTypeToObjectIdCreate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
