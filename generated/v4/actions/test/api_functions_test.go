...
func Test_actions_FunctionsApiService(t *testing.T) {
	...
	t.Run("Test FunctionsApiService FunctionsArchive", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.FunctionsApi.FunctionsArchive(context.Background(), definitionId, functionType, functionId, appId).Execute()
	...
	t.Run("Test FunctionsApiService FunctionsArchiveByType", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.FunctionsApi.FunctionsArchiveByType(context.Background(), definitionId, functionType, appId).Execute()
